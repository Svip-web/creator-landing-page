...
return '<section class="document-section block-1 figma-hero" id="block-1" data-block="1"><div class="figma-hero-bg" aria-hidden="true"><img src="assets/hero-background-only.png" alt=""></div><div class="figma-hero-people" aria-hidden="true"><img class="figma-person figma-lera" src="assets/lera-cutout.png" alt=""><img class="figma-person figma-tikhon" src="assets/tikhon-cutout.png" alt=""></div><div class="document-copy figma-hero-copy"><div class="figma-meta">'+renderLine(ls[0],0)+renderLine(ls[1],1)+'</div><h1>'+esc(ls[2])+'</h1><div class="figma-subtitle"><h2><span>'+subtitle.map(esc).join('</span><span>')+'</span></h2></div><p class="figma-byline">'+esc(ls[4])+'</p><p class="figma-description">'+esc(ls[5])+'</p>'+renderLine(ls[7],7)+'</div></section>';
}
